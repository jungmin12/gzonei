				...
				<div class="modal_form">
					<div class="form-horizontal bucket-form">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<label class="btn btn-sm btn-secondary" id="showModalBtnDtl"
									name="showModalBtn" data-ly-btn="invt-search"><span class="skip"></span>개발정보</label>
								<label class="btn btn-sm btn-secondary" id="PreViewdevBtnD"
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" name="addr" title="이름 입력" onchange="findAddrAutoID()"
									class="form-control" value="">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="apasmtAmountAD" name="apasmtAmount"
									title="사건번호 입력" class="form-control" value="">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="radio-input" type="radio" id="radio5dt" name="rewardAt" value="CM00160001">
								<label class="radio-inline" for="radio5dt">보상중</label>
								<input class="radio-input" type="radio" id="radio6dt" name="rewardAt" value="CM00160002"> 
								<label class="radio-inline" for="radio6dt">보상예정</label> 
								<input class="radio-input" type="radio" id="radio7dt" name="rewardAt" value="CM00160003">
								<label class="radio-inline" for="radio7dt">환 지</label>
								<input class="radio-input" type="radio" id="radio8dt" name="rewardAt" value="CM00160005">
								<label class="radio-inline" for="radio8dt">보상 + 환지</label>
								<input class="radio-input" type="radio" id="radio9dt" name="rewardAt" value="CM00160004">
								<label class="radio-inline" for="radio9dt">기 타</label>
							</div>
						</div>
					</div>
					<div class="text-center button_align">
						<button type="button" class="btn btn-default" id="preViewInv">미리보기</button>
					...
					<form id="proAInsertForm" name="proAInsertForm" method="post"
						...
						<div class="form-horizontal bucket-form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="bidAmountAI" id="bidAmountAI" class="form-control"
										placeholder="ex)500,000" value="">
								</div>
								<div class="col-sm-2 control-label">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="scsbidAmountAI" id="scsbidAmountAI" class="form-control"
										placeholder="ex)500,000"  value="">
								</div>
							</div>
							<div class="form-group">
					...
					<form id="proADetailForm" name="proADetailForm" method="post"
						...
						<div class="form-horizontal bucket-form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" id="bidAmountAD" name="bidAmountAD" class="form-control"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" id="scsbidAmountAD" name="scsbidAmountAD" class="form-control"
					...
					<form id="proPDetailForm" name="proPDetailForm" method="post"
						...
						<div class="form-horizontal bucket-form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text"  id="lwetAmountPD" name="lwetAmountPD" class="form-control"
										placeholder="최저금액" value="" >
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" id="scsbidAmountPD" name="scsbidAmountPD" class="form-control"
										placeholder="낙찰금액" value="" >
								</div>
							</div>
							<div class="form-group">
