							...
							<c:if test="${sessionScope.loginVO.indvdlMberCode eq 'CM00210003'}">
								<div class="form-group">
			                        ...
			                        <div class="col-sm-2 search--calendar">
									    <div>
									    	<input type="text" name="frstRegistPnttm" id="frstRegistPnttm" placeholder="작성일"  onkeyup="this.value = date_mask(this.value)" maxlength="10" value="<%=now%>"  class="form-control" autocomplete="off"/>
