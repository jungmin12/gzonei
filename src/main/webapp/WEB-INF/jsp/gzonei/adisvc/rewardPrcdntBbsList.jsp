...
// 			location.href= "<c:url value='/adisvc/rewardPrcdntBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&listGrade="+listGrade+"&seCode=prcdnt&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType+"'/>";
			
			const uri = getContextPath()+ "/adisvc/rewardPrcdntBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&listGrade="+listGrade+"&seCode=&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType;
			const encoded = encodeURI(uri);
			console.log(encoded);
			location.href = encoded;
