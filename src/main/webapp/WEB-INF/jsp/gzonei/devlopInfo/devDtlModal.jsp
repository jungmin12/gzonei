...
<!DOCTYPE html>
<!-- 개발사업 정보 상세보기 ::S -->
<div class="modal fade" role="dialog" data-ly-type="content" data-ly-target="modal-map1">
				...
				<div class="modal_form">
					<div class="form-horizontal bucket-form">
						<div class="form-group">
				            <div class="col-sm-2 control-label"><label for="birth">Gzonei 멘트</label></div>
				            <div class="col-sm-2">
				            ...
				            <div class="col-sm-8">
					            <textarea title="Gzonei 멘트" placeholder="Gzonei 멘트를 입력하세요." class="form-control" ></textarea>
				            </div>
				        </div>
						<div class="form-group">
				        ...
				        <div class="form-group">
				            <div class="col-sm-2 control-label"><label for="brhs">예상 보상 시기</label></div>
				            <div class="col-sm-4">
				            ...
				            <div class="col-sm-2 control-label"><label for="">관리자 수정일자</label></div>
				            <div class="col-sm-4">
								<div class="search--calendar">
									<span>
