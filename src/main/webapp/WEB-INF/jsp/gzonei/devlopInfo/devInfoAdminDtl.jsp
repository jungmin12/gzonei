            ...
            <div class="modal__content" style="word-break: break-all">
				...
				<div class="modal_form">
					<div class="form-horizontal bucket-form">
							...
							<div class="col-sm-8">
								...
								<div class="file-form-group devInfoAdminFileFormG">
									...
									<div class="form-input__addon">
										<label for="dtlThumbFile" class="btn btn-sm btn-secondary" data-button="upload">파일첨부하기</label>
						...
						<div class="form-group">
				            <div class="col-sm-2 control-label"><span class="devPilsu"></span><label class="sideAdmTitle" for="dwkNm">개발사업명</label></div>
				            <div class="col-sm-10">
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-3">
				            	<select id="adDtlCp1" name="adDtlCp1" class="adDtlCp1 form-control" title="시행사 선택">
                                    <option value="">선택</option>
                                </select>
				            </div>
				            <div class="col-sm-4">
				            	<select id="adDtlCp2" name="adDtlCp2" class="adDtlCp2 form-control" title="시행사 선택">
                                    <option value="">선택</option>
                                </select>
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-4">
				                <input class="radio-input" type="radio" id="dtlDwkOthbcAtY" name="dwkOthbcAt" title="공개" value="Y"/>
				            ...
				            <div class="col-sm-4">
				                ...
				                <input class="radio-input" type="radio" id="dtlSmpleInqireAtN" name="smpleInqireAt" title="비공개" value="N"/>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-2">
								<input type="text" class="form-control moneyDev" name="wct" id="dtlWct" placeholder="사업비" value="" title="사업비 입력">
				            </div>
				            <div class="col-sm-2">
				            ...
				            <div class="col-sm-2">
								<input type="text" class="form-control moneyDev" name="lct" id="dtlLct" placeholder="용지비" value="" title="용지비 입력">
				            </div>
				            <div class="col-sm-2">
					...
					<div class="text-center button_align">
						<button type="button" id="devInfoAdDtlShowDtlBtn" class="btn btn-default">개발정보 보기</button>
