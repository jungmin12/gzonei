				...
				<div class="pagination-inner">
					...
					<c:if test="${sessionScope.loginVO.indvdlMberCode eq 'CM00210003'}">
						<div class="button-group">
							<a href="<c:url value='/strBbsRegist.do?readngAuthorCode=003'/>" class="btn btn-default">등록</a>
						</div>
					</c:if>
				</div>
				<!-- Paging : E -->
...
<script>
	function search() {
	    ...
	    if(startDate != "" || endDate != ""){
	       ...
	       document.searchForm.action = "<c:url value='/str/strFailrBbsList.do'/>";
	...
	function loginCheck(nttId, articleNum, loginGrade){
		...
		if(loginGrade == null || loginGrade == ""){
			...
			const uri = getContextPath()+ "/str/strBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&readngAuthorCode=003&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType;
			const encoded = encodeURI(uri);
			console.log(encoded);
			location.href = encoded;
			
// 			location.href= "<c:url value='/str/strBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&readngAuthorCode=003&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType+"'/>";
