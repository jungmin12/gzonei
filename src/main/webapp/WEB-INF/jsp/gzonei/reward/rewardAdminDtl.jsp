                ...
                <div class="modal_form">
                    <div class="form-horizontal bucket-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <label class="btn btn-sm btn-secondary" id="rwdDevModalD" name="rwdDevModalD" data-ly-btn="reward-search" title="[Step-1]개발사업을 검색합니다.">
                    ...
                    <div class="text-center button_align">
                        ...
                        <button type="button" class="btn btn-default" onclick="javascript:sideShow('rewardAdminList');">취소</button>
                    </div>
                </div>
            </form>
        </div>
