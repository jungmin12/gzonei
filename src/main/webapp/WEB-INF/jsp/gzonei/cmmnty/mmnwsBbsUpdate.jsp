...
<script>
		...
		function date_mask(objValue) { //기사일자 date 형식으로 받기
			 var v = objValue.replace("--", "-");
    ...
    <div class="body_wrap layout">      
        <div id="contens" class="contents_wrap">
			...
			<div class="board_view_in">
                    ...
                    <input type="hidden" name="devlopInfoSn" value="${devResult.devlopInfoSn}"/>
...
<!-- 						    </div> -->
						    ...
						    <div class="col-sm-2 search--calendar">
							    <div>
							    	<input type="text" name="articlDe" id="articlDe" placeholder="기사일자" class="form-control" onkeyup="this.value = date_mask(this.value)" maxlength="10" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${result.articlDe}"/>" autocomplete="off" onkeyup="this.value = date_mask(this.value)" maxlength="10"/>
...
<!-- 						    <div class="col-sm-2 search--calendar"> -->
<!-- 							    <div> -->
							    	<input type="hidden" name="frstRegistPnttm" id="frstRegistPnttm" placeholder="작성일자" value="<fmt:formatDate  value="${result.frstRegistPnttm}" pattern="yyyy-MM-dd"/>" class="form-control" />
<!-- 							    	<button type="button" class="btn__calendar"><span class="skip">달력선택</span></button> -->
<!-- 								</div> -->
<!-- 							</div> -->
							</div>
...
<!-- 							<div class="col-sm-2 control-label col-lg-2"><div class="label">개발 사업명</div></div>	 -->
							<div class="col-sm-4">
											...
											<input type="hidden" name="blogId" id="blogid" value="${result.blogId }"/>
							</div>
							<div class="col-sm-1">										
