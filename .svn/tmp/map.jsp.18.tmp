					...
					<div id="app">
						<div id="totalWrap">
							...
							<div id="popup" class="ol-popup">
								...
								<a href="#" id="popup-closer" class="ol-popup-closer">닫기</a>
							</div>
							<div id="mapTabs">
							...
							<div id="quickGuide">
									...
									<div class="item">
										...
										<div class="dropbox">
											<button type="button" class="text-button"
												onclick="sideShow('devInfoAdminList');"
												id="devInfoAdminListBtn">개발 정보</button>
											<button type="button" class="text-button"
												onclick="invtAdminShow();">투자 정보</button>
											<button type="button" class="text-button"
												onclick="sideShow('rewardAdminList');">보상 전례</button>
										</div>
									</div>
								</c:if>
								...
								<button type="button" class="mapir icon12" title="레이어 삭제" id="deleteLayer"
									onclick="deleteLayer();" style="display: none">11</button>
...
<!-- 									<strong class="mapir title">주소 검색</strong> -->
									<strong class="" style="color:#fff;font-size:18px;">개발사업명 검색</strong>
								...
								<div id="searchFormTab" class="ui-tablist">
									...
									<div class="tabpanel_box">
													...
													<form id="devInfoInfoListForm" name="devInfoInfoListForm">
														...
														<div class="form-group">
															...
															<c:if test="${authVO.dev001003.infoInqireAt eq 'Y'}">
																<div class="alarmTxt">전국 검색시 검색시간이 지연(3분이상)됩니다.</div>
															</c:if>
														</div>
														<!-- 상세검색 -->
														...
														<div class="mapSearch__biz">
															...
															<c:if test="${loginVO.get('indvdlMberCode') eq 'CM00210003' }">
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<select name="rewardAt" id="rewardAt" class="form-control"
																			title="협의보상상태 선택" required="">
																			<option value="">전체</option>
																		</select>
																	</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-12">
																		<label><input type="checkbox" name="bsnsMthdCode" value="CM00150001"> 수용 및 사용 </label>
																		<label><input type="checkbox" name="bsnsMthdCode" value="CM00150002"> 환지</label> 
																		<label><input type="checkbox" name="bsnsMthdCode" value="CM00150003"> 수용 및 사용 + 환지</label>
																		<label><input type="checkbox" name="bsnsMthdCode" value="CM00150004"> 기타</label>
																	</div>
																</div>
															</c:if>
										...
										<div class="obj" id="tab-panel3" role="tabpanel" aria-labelledby="tab3">
										    <strong class="skip">투자정보 검색</strong>
										    <div class="scrollbar mCustomScrollbar _mCS_3 mCS-autoHide">
										        <div id="mCSB_3" class="mCustomScrollBox mCS-dark-1 mCSB_vertical mCSB_inside" tabindex="0" style="max-height: none;">
										                ...
										                <div class="mapAll">
										                    <ul>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub open">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq153");'>도시계획(공간시설)<%-- <span class="tooltip" data-toggle="tooltip" data-container="body" data-html="true" title="<h5>특급노하우</h5><p><p style='width:20px;height:12px;border-width:1px;background:url(http://map.vworld.kr/images/symbol/pattern/vertical_red_3.png) repeat 0 0px;background-color: undefined;border-color: #434343; float:left; margin:5px 2px;border-style:solid;'></p>범례내용</p>">범례</span> --%></label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq155");'>도시계획(공공문화체육시설)</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq156");'>도시계획(방재시설)</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq157");'>도시계획(보건위생시설)</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq161");'>지구단위계획</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq171");'>개발행위허가제한지역</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq152");'>도시계획(교통시설)</label></div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq151");'>도시계획(도로)</label></div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_upisuq175");'>토지거래계약에관한허가구역</label></div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_lhblpn");'>토지이용계획도</label></div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                                </div>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_damdan");'>단지경계</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_damyoj");'>단지시설용지</label>
										                                                </div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_wkmstrm");'>하천망</label>
										                                                </div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_uq129");'>개발진흥지구</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_uma100");'>국립공원용도지구</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_uq162");'>도시자연공원구역</label>
										                                                </div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                        ...
										                        <li>
										                            <div class="mapsCont">
										                                <div class="dv">
										                                    <div class="inner minus2">용도지역지구(기타)</div>
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_uo601");'>관광지</label></div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_ud610");'>국민임대주택</label></div>
										                                            </li>
										                                            <li>
										                                                <div class="module"><label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_uh501");'>유통단지</label></div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                                </div>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_adsigg");'>시군구경계도</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_lhzone");'>사업지구경계도</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lp_pa_cbnd_bonbun,lp_pa_cbnd_bubun");'>지적도</label>
										                                                </div>
										                                            </li>
										                                        </ul>
										                                    </div>
										                                ...
										                                <div class="dv">
										                                    ...
										                                    <div class="list sub">
										                                        <ul>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_wgisnpgug");'>국립자연공원</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_wgisnpgun");'>군립자연공원</label>
										                                                </div>
										                                            </li>
										                                            <li>
										                                                <div class="module">
										                                                    <label class="lbl_list"><input type="checkbox" onclick='layer_box_chk(this.checked,"lt_c_wgisnpdo");'>도립자연공원</label>
										                                                </div>
										                                            </li>
										                                        </ul>
										                                    </div>
											...
											<script>
												$(document).ready(
																function() {
																	...
																	$("#startDate,#endDate,#startDate3,#endDate3,#startDateInvAd,#endDateInvAd,#beginPnttmInvAL,#endPnttmInvAL,#startDateIAI,#endDateIAI,#startDateIAD,#endDateIAD")
																			.datetimepicker(
																					{
																						timepicker : false,
																						format : 'Y-m-d',
