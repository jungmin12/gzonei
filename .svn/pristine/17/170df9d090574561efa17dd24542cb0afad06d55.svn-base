						...
						<table class="table table-bordered text-center">
							...
							<tbody>
								...
								<c:if test="${resultInfo.indvdlMberCode eq 'CM00210002'}">
	                        		<td onClick="javascript:fn_detail_mber('${resultInfo.emplyrId }');" style="cursor:pointer;color:#2257d5;">${resultInfo.cmpnyNm }</td>
								</c:if>
								<c:if test="${resultInfo.indvdlMberCode ne 'CM00210002'}">
	                        		<td onClick="javascript:fn_detail_mber('${resultInfo.emplyrId }');" style="cursor:pointer;color:#2257d5;">${resultInfo.userNm }</td>
								</c:if>
