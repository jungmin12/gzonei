        ...
        <div id="contens" class="contents_wrap">
            ...
            <!-- content 영역입니다. -->
                ...
                <div class="sub0902_wrap">
                            ...
                            <ul class="box">
                                <li class="box_inner box_1">
                                    ...
                                    <div class="txt">
                                        ...
                                        <span class="txt_inner">12개월<em>16,8020,000</em></span>
                                    </div>
                                </li>
                                <li class="box_inner box_2">
                                    <p>스페셜</p>
                    ...
                    <p class="date">기준일 : 2021년 05월 20일​, 부가세포함금액/원</p>
                    ...
                    <ul class="bank">
                        <li><em>입금계좌안내</em>예금주 : (주)전국개발정보지존</li>
                    ...
                    <h2 class="h2 mem_info">회원등급별 정보이용범위</h2>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-1st mem_list">
                                            <li>골드 이코노미 회원 + 기타 사업지구 [Ⅰ] 개발정보 상세정보 열람 가능(프리미엄 존 포함)​</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-1st mem_list">
                                            <li>실버 스페셜 회원 + 일반사업지구 [Ⅱ] 개발정보 상세정보 열람 가능(단, '프리미엄 존' 포함)</li>
                                            <li>개발정보 '골드 존' 열람 가능</li>
                                            <li>기타사업지구[Ⅰ], [Ⅱ] 개발정보 기본정보 열람 가능(단, 프리미엄 존 이용 불가)</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-1st mem_list">
                                            <li>실버 이코노미 회원 + 개발정보 추진내역 중 (지구지정, 구역지정, 단지지정 ,결정) 고시, 지구(개발)계획, 및 실시계획 승인(인가) 고시의 변경 내역 열람가능</li>
                                        </ul>
                                    </td>
                                    <td>110,000</td>
                                    <td>198,000</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-1st mem_list">
                                            <li>무료회원 서비스 + 일반사업지구[Ⅰ] 개발정보 상세정보 열람 가능(골드 존, 프리미엄 존 포함)</li>
                                            <li>일반사업지구[Ⅱ] 및 기타사업지구[Ⅰ], [Ⅱ] 개발정보 기본정보(실버 존 포함) 열람 가능(단, 골드 존, 프리미엄 존, 향후 추진계획, 대표주소 상세주소, 추 진내역 중(지구지정, 구역지정, 단지지정, 결정) 고시 및 지구(개발)계획, 및 실시계획 승인(인가) 고시의 변경 내역 열람 불가)</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-1st mem_list">
                                            ...
                                            <li>'우리 동네 개발사업이 궁금하세요' 이용 가능 (단, 일반사업지구 I, II 의 기본정보에 한함)</li>
                    ...
                    <div id="business"></div>
                    <h2 class="h2 busi_sort">사업지구 분류</h2>
                    ...
                    <ul class="guide_list">
                        <li>
                            ...
                            <div class="txt">
                                <p>사이트 보안을 위해 1개 ID로 다수의 사용자가 동시에 로그인하여 사용할 경우(동일PC도 적용) 해당 ID에 대해 모두 자동 로그아웃되며 24시간 동안 로그인을 할수 없도록 제한합니다.</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="txt">
                                <p>사용하지 않을 경우 로그아웃을 해야 불이익을 피할 수 있으며, 페이지 갱신없이 (브라우저를 종료하는 등) 30분이 경과한 경우 자동 로그아웃이 됩니다.</p>
                            </div>
                        </li>
                    </ul>
                    <div class="mem_btn">
