...
<h1 style="margin-bottom: 50px;font-size: 40px;color: #000;">회원정보입력 (화면정의서 15p)</h1> <!--페이지 안내 텍스트 입니다 개발 시 지워주세요-->
<ul class="step_list">
...
<div class="join_wrap">
    ...
    <div class="form-horizontal bucket-form">
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="name"><span class="pilsu">필수입력</span>담당자명</label></div>
            <div class="col-sm-4">
    ...
    <div class="form-horizontal bucket-form">
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="name"><span class="pilsu">필수입력</span>회사(상호)명</label></div>
            <div class="col-sm-4">
                <input type="text" value="" id="name" name="name" title="회원명 입력" class="form-control indispensable">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="tel"><span class="pilsu">필수입력</span>사업자번호</label></div>
            <div class="col-sm-10">
                <div class="form-inline">
	            <input type="text" id="biz1" name="" title="사업자번호 두번째창 입력" class="form-control" value="" onkeydown="onlyNumber(this)">
				<span>-</span>
                <input type="text" id="biz2" name="" title="사업자번호 두번째창 입력" class="form-control" value="" onkeydown="onlyNumber(this)">
                <span>-</span>
                <input type="text" id="biz3" name="" title="사업자번호 세번째창 입력" class="form-control" value="" onkeydown="onlyNumber(this)">
                <input type="hidden" name="tel3" value="">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="biz_name"><span class="pilsu">필수입력</span>대표자명</label></div>
            <div class="col-sm-10">
                <div class="form-inline">
                    <input type="text" value="" id="biz_name" name="biz_name" title="대표자명" class="form-control">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="bizemail1"><span class="pilsu">필수입력</span>이메일 </label></div>
            <div class="col-sm-10">
                <div class="form-inline">
                    <input type="text" id="bizemail1" name="email" title="이메일 주소 입력" class="form-control indispensable" value="">
                    <span>@</span>
                    <input type="text" id="bizemail2" name="email" title="이메일 도메인 입력" class="form-control indispensable">
                    <select id="bizemailSel" title="이메일 도메인 선택" class="form-control" onchange="javascript: setEmailSelectBox(this)">
                        <option value="" selected="selected">직접입력</option>
                        <option value="naver.com">네이버</option>
                        <option value="daum.net">다음</option>
                        <option value="hanmail.net">한메일</option>
                    ...
                    <input type="hidden" name="bizemail" value="">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="biz_1"><span class="pilsu">필수입력</span>업종</label></div>
            <div class="col-sm-10">
                <div class="form-inline">
                    <input type="text" value="" id="biz_1" name="biz_1" title="업종" class="form-control">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-2 control-label"><label for="biz_1"><span class="pilsu">필수입력</span>업태</label></div>
            <div class="col-sm-10">
                <div class="form-inline">
                    <input type="text" value="" id="biz_2" name="biz_2" title="업태" class="form-control">
                </div>
            </div>
        </div>
        <div class="form-group">
...
<h1 style="margin-bottom: 50px;font-size: 40px;color: #000;">회원가입완료 (화면정의서 15p)</h1> <!--페이지 안내 텍스트 입니다 개발 시 지워주세요-->
<ul class="step_list">
    <li><span></span>회원선택</li>
    <li><span></span>약관동의</li>
