...
public class ColmnController {
    ...
    public String selectColmnList(RedirectAttributes redirect, HttpServletRequest request, HttpServletResponse response, Model model) throws SQLException , IOException {
        ...
        //접근권한 
        if(auth!=null) {
			authInfo =  (EgovMap) auth.get("bbs007001");
...
//      검색 조건 설정
	    ...
	    public String selectColmnArticleDetail(@RequestParam Map<String, Object> commandMap,RedirectAttributes redirect, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception  {
			EgovMap searchVO = new EgovMap();
	    ...
	    public String toinsertColmnArticleList(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirect,Model model) throws SQLException , IOException {
	    	//페이지 접근 권한 설정-------
	        EgovMap session = (EgovMap) request.getSession().getAttribute("loginVO");
	        EgovMap auth = (EgovMap)request.getSession().getAttribute("authVO");
	        EgovMap authInfo = new EgovMap();
	    ...
	    public String toupdateColmnArticleList(HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirect,Model model) throws SQLException , IOException {
	    	//페이지 접근 권한 설정-------
	        EgovMap session = (EgovMap) request.getSession().getAttribute("loginVO");
	        EgovMap auth = (EgovMap)request.getSession().getAttribute("authVO");
	        EgovMap authInfo = new EgovMap();
