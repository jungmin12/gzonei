        ...
        <div id="contens" class="contents_wrap">
			...
			<div id="info" class="sample">
					...
					<div class="ui-tip__box">
						<p class="txt-tip txt-small">본 개발정보는 2021년 02월 27일까지 공개된 자료와 Gzone 당사가 직접 취재한 내용을 바탕으로 최종 수정된 자료입니다. 금일 이후 사업시행자의 사정 또는 경제여건의 변화 등에 따라 사업은 축소.확대.변경.취소 및 지연될 수 있으니 이용자께서는 이점 유의하시길 바랍니다.</p>
