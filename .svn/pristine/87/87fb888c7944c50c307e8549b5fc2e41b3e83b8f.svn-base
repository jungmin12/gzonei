										...
										<fieldset>
	                                        ...
	                                        <div class="search custom-search" style="margin-bottom: unset;padding: 1px 10px;">
												<div class="form-group p-row" style="margin-top: 14px;">
	                                             ...
	                                             <select id='nwsArea1' name='area1' class="nwsArea1 p-control" >
													<option value="">전체</option>
	                                             </select>
	                                             </div>
	                                            <div class="p-col-10 p-col-sm-18">
	                                             <select id='nwsArea2' name='area2' class="nwsArea2 p-control" >
													<option value="">전체</option>
	                                             </select>
	                                             </div>
	                                           </div>
												<div class="form-group p-row" style="margin-top: 14px;">
													<div class="p-col-3 control-label" style="text-align: center;"><label class="mapTitle" for="area1">검색어</label></div>
		                                             ...
		                                             <div class="p-col-10 p-col-sm-18">
		                                                 <input type="text" name="textSearch"  title="검색어를 입력해주세요" placeholder="검색어를 입력해주세요" class="p-control" onkeypress="return enterkeyInv();" autofocus/>
		                                             </div>
		                                             <div class="p-col-5  p-col-sm-24">
		                                                  <button type="button" class="searchMember" onclick="javascript:;" id="nwsDevlopListSearch"  onkeypress="return enterkeyInv()">검색</button>
		                                             </div>
	                                           </div>
	                                          </div>
	                                     </fieldset>
