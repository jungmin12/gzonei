            ...
            <div class="modal__content" style="word-break: break-all">
				...
				<div class="modal_form">
					<div class="form-horizontal bucket-form">
						...
						<div class="form-group">
				            <div class="col-sm-2 control-label"><label class="sideAdmTitle" for="dwkNo">개발사업명</label></div>
				            <div class="col-sm-10">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-4">
								<input type="text" class="form-control money" name="wct" id="insrtWct" placeholder="사업비" value="" title="사업비 입력">
				            </div>
				            <div class="col-sm-2 control-label"><label class="sideAdmTitle" for="lct">용지비</label></div>
				            <div class="col-sm-4">
								<input type="text" class="form-control money" name="lct" id="insrtLct" placeholder="용지비" value="" title="용지비 입력">
				            </div>
				        </div>
				        <div class="form-group">
