	...
	<form name="invtAdmForm" id="invtAdmForm">
		...
		<div class="modal_form">
			<div class="form-horizontal bucket-form">
				...
				<div class="form-group">
					<div class="col-sm-1 control-label">
						<label class="mapTitle">입찰기간</label>
					</div>
					<div class="col-sm-4">
						<div class="search--calendar" style="width: 49%;">
							<span> <input type="text" class="form-control"
								name="beginPnttm" id="beginPnttmInvAL" placeholder="시작일" value=""
								title="시작일 입력">
								<button type="button" class="btn__calendar">
									<span class="skip">달력선택</span>
								</button>
						...
						<div class="search--calendar" style="width: 49%;">
							<span> <input type="text" class="form-control"
								name="endPnttm" id="endPnttmInvAL" placeholder="종료일" value=""
								title="종료일 입력">
								<button type="button" class="btn__calendar">
									<span class="skip">달력선택</span>
								</button>
					...
					<div class="col-sm-1 control-label">
						<label class="mapTitle">공개여부</label>
					</div>
					<div class="col-sm-4">
						<select name="cntntsOthbcAt" id="cntntsOthbcAtAL"
							class="form-control">
					...
					<div class="col-sm-1 control-label" style="display:none;">
						<label class="mapTitle">삭제여부</label>
					</div>
					<div class="col-sm-2" style="display:none;">
						<select name="delAt" id="delAtAL"
							class="form-control">
							<option value="">전체</option>
							<option value="Y">삭제</option>
							<option value="N" selected>미삭제</option>
						</select>
					</div>
				</div>
				<div class="form-group">
