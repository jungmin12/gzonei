                    ...
                    <div class="form-horizontal bucket-form">
						...
						<div class="form-group">
						    <div class="col-sm-2 control-label col-lg-2">
						    	<div class="label">제목 <span class="pilsu">필수</span></div></div>
						    <div class="col-sm-9">
...
<!-- 							------------관리자 권한 넣기전 조치======================= -->
						<c:if test="${sessionScope.authVO.bbs003001.infoDspyAt == 'Y'}"> 
							<div class="form-group">
								<div class="col-sm-2 control-label col-lg-2">
									<div class="label">공지여부 <span class="pilsu">필수</span></div></div>
							    <div class="col-sm-2">
