                    ...
                    <div class="form-horizontal bucket-form">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-2 search--calendar">
							    <div>
							    	<input type="text" name="articlDe" id="articlDe" placeholder="기사일자" class="form-control" autocomplete="off" />
						...
						<c:if test="${sessionScope.authVO.bbs005001.infoDspyAt == 'Y'}">
							...
							<div class="col-sm-1 control-label col-lg-1"><div class="label">전시여부 </div></div>
						    <div class="col-sm-2">
