               ...
               <div class="sub0901_wrap">
					...
					<li role="presentation" class="js-tab"><a role="tab" id="tab6" aria-controls="tab-panel6" href="#tab-panel6" aria-selected="false"><span class="ir ir-icon ir-icon__line icon6"></span><span>마이페이지</span></a></li>
						...
						<div class="tabpanel on" id="tab-panel1" role="tabpanel" aria-labelledby="tab1" tabindex="0">
							...
							<div class="tab_txt"><p>현재 보상(환지포함)진행중인 개발사업지구부터 개발예정지역에 편입되어 향후 보상을 앞둔 사업지구, 보상이 완료되어 주변 일대에 수혜가 기대되는 사업지구까지- 전국의 주요 개발사업지구의 추진내역 및 향후 추진일정, 각종 고시공고 파일은 물로 지존이 직접 취재해 누구도 따라올 수 없는 차별화된 생생한 정보를 제시합니다.</p></div>
							<button type="button" class="btn btn-primary"  onclick="location.href='<c:url value='/design/devlopFree01View.do'/>' "><a href="<c:url value='/design/devlopFree01View.do'/>" title="새창열기" rel="noopener noreferrer">개발정보 샘플보기</a></button>
