...
<script>
		...
		function update() {		
			...
			Common.Dialog.confirm({
	            ...
	            ,ok: function(){
	            	document.updateForm.action="<c:url value='/cmmnty/todayBbsUdt.do'/>";
			...
			<div class="board_view_in">
                    ...
                    <div class="form-horizontal bucket-form">
						<div class="form-group">
						    <div class="col-sm-2 control-label "><div class="label">제목<span class="pilsu">필수</span></div></div>
						    <div class="col-sm-9">
						...
						<c:if test="${sessionScope.authVO.bbs001002.infoDspyAt eq 'Y'}">
						 <div class="form-group">
<!--                             <div class="col-sm-2 control-label "><label for="select">사용여부</label></div> -->
<!--                             <div class="col-sm-2"> -->
