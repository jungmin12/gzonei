		...
		function update() {	
			if(validate()){
				Common.Dialog.confirm({
		            ...
		            ,ok: function(){
		            	document.updateForm.action="<c:url value='/cmmnty/colmnBbsUdt.do'/>";
                    ...
                    <div class="form-horizontal bucket-form">
						...
						<div class="col-sm-2 control-label col-lg-2"><div class="label">작성 일자 <span class="pilsu">필수</span></div></div>
						    <div class="col-sm-2 search--calendar">
							    <div>
							    	<input type="text" name="frstRegistPnttm" id="frstRegistPnttm" placeholder="작성일자" value="<fmt:formatDate  value="${result.frstRegistPnttm}" pattern="yyyy-MM-dd"/>" class="form-control" onkeyup="this.value = date_mask(this.value)" maxlength="10"  autocomplete="off"/>
						...
						<c:if test="${sessionScope.authVO.bbs001001.infoDspyAt == 'Y'}"> 
						 ...
						 <div class="form-group">
<!--                             <div class="col-sm-1 control-label col-lg-2"><div class="label">사용여부</div></div> -->
<!--                             <div class="col-sm-2"> -->
...
<!-- 						<div class="form-group"> -->
<!-- 							<div class="col-sm-2 control-label col-lg-2"><div class="label">저자</div></div> -->
<!-- 						    <div class="col-sm-2"> -->
<%-- 						    	<input type="text" maxlength="10" name="nsprcNm" id="nsprcNm" value="${result.nsprcNm}" > --%>
<!-- 							</div> -->
<!-- 							<div class="col-sm-2 control-label col-lg-2"><div class="label">칼럼 일자 <span class="pilsu">필수</span></div></div> -->
<!-- 						    <div class="col-sm-2"> -->
<%-- 						    	<input type="date" name="articlDe" id="articlDe"  value="${result.articlDe}"/> --%>
<!-- 							</div> -->
<!-- 						</div>  -->
						<div class="form-group">
						    <div class="col-sm-12">
