...
<script>
	...
	function cancle() {
		document.location.href="<c:url value='/cmmnty/colmnBbsList.do'/>";
	}
	function validate(){
		if ($('#nttSj').val() == '') {
			Common.Dialog.alert({
	...
	function insert() {
		...
		Common.Dialog.confirm({
            ...
            ,ok: function(){
            	document.insertForm.action="<c:url value='/cmmnty/colmnBbsRgst.do'/>";
                    ...
                    <div class="form-horizontal bucket-form">
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-2 search--calendar">
							    <div>
							    	<input type="text" name="frstRegistPnttm" id="frstRegistPnttm" placeholder="작성일자" class="form-control" value="<%=now%>"   autocomplete="off"  onkeyup="this.value = date_mask(this.value)" maxlength="10"/>
							    	<button type="button" class="btn__calendar"><span class="skip">달력선택</span></button>
								</div>
							</div>
						</div> 
<!-- 							------------관리자 권한 넣기전 조치======================= -->
						<c:if test="${sessionScope.authVO.bbs007001.infoDspyAt == 'Y'}">
						<div class="form-group">
							<div class="col-sm-2 control-label col-lg-2"><div class="label">공지 여부 </div></div>
						    <div class="col-sm-2">
						    	<div class="label-text"><input type="checkbox"  value="Y" name="noticeAt">&nbsp;&nbsp;공지</div>
							</div>
							<div class="col-sm-2 control-label col-lg-2"><div class="label">전시 여부</div></div>
...
<!-- 						<div class="form-group"> -->
<!-- 							<div class="col-sm-2 control-label col-lg-2"><div class="label">저자<span class="pilsu">필수</span></div></div> -->
<!-- 						    <div class="col-sm-2"> -->
<!-- 						    	<input type="text" class="form-control" name="nsprcNm" id="nsprcNm" > -->
<!-- 							</div> -->
<!-- 							<div class="col-sm-2 control-label col-lg-2"><div class="label">칼럼 일자 <span class="pilsu">필수</span></div></div> -->
<!-- 						    <div class="col-sm-2"> -->
...
<!-- 										    	<option value="CM00200011">프리미엄 (스페셜)</option> -->
									...
									<input type="hidden" name="bbsId"  value="BBSMSTR_000000000009"/>
