									...
									<c:otherwise>
										<c:forEach items="${resultList}" var="list" varStatus="status">
											...
											<tr>
												...
												<td class="subject">
													<a href="javascript:toDetail('/adisvc/rewardPrcdntBbsDetail.do?nttId=${list.nttId}&pageIndex=${paginationInfo.currentPageNo}&articleNum=${articleNum}&listGrade=${listGrade}&startDate=${searchVO.startDate}&endDate=${searchVO.endDate}&searchType=${searchVO.searchType}&keyword=${searchVO.keyword}&orderType=${searchVO.orderType}')">
 ...
 <script>
	function search() {
	    ...
	    if(startDate != "" || endDate != ""){
	       ...
	       document.searchForm.action = "<c:url value='/adisvc/rewardPrcdntBbsList.do'/>";
...
// 			location.href= "<c:url value='/adisvc/rewardPrcdntBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&listGrade="+listGrade+"&seCode=prdcnt&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType+"'/>";
			
			const uri = getContextPath()+ "/adisvc/rewardPrcdntBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&listGrade="+listGrade+"&seCode=prdcnt&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType;
			const encoded = encodeURI(uri);
			console.log(encoded);
			location.href = encoded;
