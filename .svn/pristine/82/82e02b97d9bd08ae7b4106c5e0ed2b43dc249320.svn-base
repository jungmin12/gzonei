			...
			<script>
		      function search() {
		          ...
		          if(startDate != "" || endDate != ""){
		             ...
		             document.searchForm.action = "<c:url value='/cmmnty/focusBbsList.do'/>";
...
<%-- 															<a href="<c:url value='/cmmnty/focusBbsDetail.do?pageIndex=${paginationInfo.currentPageNo}&nttId=${notice.nttId}&articleNum=${paginationInfo.totalRecordCount-((paginationInfo.currentPageNo-1)*paginationInfo.pageSize + status.count-1)}&startDate=${searchVO.startDate}&endDate=${searchVO.endDate}&searchType=${searchVO.searchType}&keyword=${searchVO.keyword}&orderType=${searchVO.orderType}' />"> --%>
														...
														<td class="mo-hide">
															<span class="td__date">
				                                            	...
				                                            	<c:if test="${notice.useAt eq  'Y'}">미삭제</c:if>
				                                            	<c:if test="${notice.useAt eq  null || notice.useAt eq '' || notice.useAt eq 'N'}">삭제</c:if>
															</span>
														</td>
														<td class="regDate">
														 	<span class="td__date">
												...
												<c:forEach var="list" items="${resultList}" varStatus="status">
					                              ...
					                              <c:set var="diffDate" value="${strDate - endDate}"/>
													<tr>
														...
														<td class="subject">
<%-- 															<a href="<c:url value='/cmmnty/focusBbsDetail.do?pageIndex=${paginationInfo.currentPageNo}&nttId=${list.nttId}&articleNum=${paginationInfo.totalRecordCount-((paginationInfo.currentPageNo-1)*paginationInfo.pageSize + status.count-1)}&startDate=${searchVO.startDate}&endDate=${searchVO.endDate}&searchType=${searchVO.searchType}&keyword=${searchVO.keyword}&orderType=${searchVO.orderType}' />"> --%>
															<a href="javascript:toDetail('/cmmnty/focusBbsDetail.do?pageIndex=${paginationInfo.currentPageNo}&nttId=${list.nttId}&articleNum=${paginationInfo.totalRecordCount-((paginationInfo.currentPageNo-1)*paginationInfo.pageSize + status.count-1)}&startDate=${searchVO.startDate}&endDate=${searchVO.endDate}&searchType=${searchVO.searchType}&keyword=${searchVO.keyword}&orderType=${searchVO.orderType}')" >
															<c:if test="${diffDate <= 3}"><span class="txt_blt02 bgc01">새글</span></c:if>
															${list.nttSj}
															</a>
...
<!-- 														</td> -->
				...
				<div class="pagination-inner">
					...
					<div class="button-group">
						<a href="<c:url value='/cmmnty/focusBbsRegist.do'/>" class="btn btn-default">등록</a>
					</div>
					</c:if>
                </div>
				<!-- Paging : E -->
