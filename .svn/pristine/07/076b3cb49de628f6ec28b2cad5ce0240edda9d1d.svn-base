...
<!--                                 </div> -->
                    ...
                    <div class="board_btm">
                        <div class="btns_area fl_r mo_block">
                        	...
                        	<c:if test="${searchVO.pageIndex == null}">
                        	<c:if test="${searchVO.seCode eq null or searchVO.seCode eq ''}"> <a href="<c:url value='/adisvc/rewardPrcdntBbsList.do'/>" class="btn btn-success" id="toList">목록</a></c:if>
