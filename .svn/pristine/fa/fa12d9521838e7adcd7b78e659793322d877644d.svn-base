						...
						<div class="form-group">
							<div class="col-sm-2 control-label col-lg-2"><div class="label">기사 일자 <span class="pilsu">필수</span></div></div>
								    <div class="col-sm-2 search--calendar">
									    <div>
									    	<input type="text" name="articlDe" id="articlDe" placeholder="기사일자" class="form-control" onkeyup="this.value = date_mask(this.value)" maxlength="10" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${result.articlDe}"/>" autocomplete="off"/>
