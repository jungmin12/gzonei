...
public class NoticeController {
    ...
    public String selectNoticeArticleList(RedirectAttributes redirect,HttpServletRequest request, HttpServletResponse response, Model model) throws SQLException , IOException {
        ...
        //접근권한 
        if(auth!=null) {
			authInfo =  (EgovMap) auth.get("bbs003001");
		...
		searchVO.put("bbsId","BBSMSTR_000000000001" );
	    ...
	    public String selectNoticeArticleDetail(RedirectAttributes redirect, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception  {
			EgovMap searchVO = new EgovMap();
...
//			strservice.strBbsDelete(searchVO);
	    ...
	    public String insertNoticeArticle(@RequestParam Map<String, Object> commandMap, HttpServletRequest request,
	    ...
	    public String toinsertNoticeArticleList(HttpServletRequest request,RedirectAttributes redirect, HttpServletResponse response, Model model) throws SQLException , IOException {
	        //페이지 접근 권한 설정
	        EgovMap session = (EgovMap) request.getSession().getAttribute("loginVO");
	        EgovMap auth = (EgovMap)request.getSession().getAttribute("authVO");
	        EgovMap authInfo = new EgovMap();
	        ...
	        //접근권한 
	        if(auth!=null) {
				authInfo =  (EgovMap) auth.get("bbs003002");
	    ...
	    public String toupdateNoticeArticleList(HttpServletRequest request,RedirectAttributes redirect, HttpServletResponse response, Model model) throws SQLException , IOException {
