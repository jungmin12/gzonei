...
<script>
	...
	function loginCheck(nttId, articleNum, loginGrade){
		...
		if(loginGrade == null || loginGrade == ""){
			...
			const uri = getContextPath()+"/str/strBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType;
			const encoded = encodeURI(uri);
			console.log(encoded);
			location.href = encoded;

// 			location.href= "<c:url value='/str/strBbsDetail.do?pageIndex="+pageIndex+"&nttId="+nttId+"&articleNum="+articleNum+"&startDate="+startDate+"&endDate="+endDate+"&searchType="+searchType+"&keyword="+keyword+"&orderType="+orderType+"'/>";
		}
	}
