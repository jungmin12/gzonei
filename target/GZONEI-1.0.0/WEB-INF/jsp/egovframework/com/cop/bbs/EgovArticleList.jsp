	...
	<tr>
		...
		<td class="bold">
			<form name="subForm" method="post" action="<c:url value='/cop/bbs/selectArticleDetail.do'/>">
			    ...
			    <span class="link"><input type="submit" value="<c:out value='${fn:substring(noticeInfo.nttSj, 0, 40)}'/><c:if test="${noticeInfo.commentCo != ''}">	<c:out value='[${noticeInfo.commentCo}]'/></c:if>">
			    </span>
			</form>
		</td>
		<td><c:out value='${noticeInfo.frstRegisterId}'/></td>
