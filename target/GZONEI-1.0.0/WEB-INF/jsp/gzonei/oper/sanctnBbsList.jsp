...
<%-- 												</c:if> --%>
				...
				<!-- Paging : S -->
					<div class="pagination-inner">
						...
						<c:if test="${sessionScope.authVO.adm001001.infoRegistAt eq 'Y'}">					
