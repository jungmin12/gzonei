            ...
            <!-- content 영역입니다. -->
				...
				<div class="agree">
				    ...
				    <div class="agree-box">
	                    ...
	                    <p>본 약관은 전국개발정보 지존(이하&#34;회사&#34;라 함)에서 제공하는 인터넷상의 부동산 개발정보 및 보상과 관련된 정보서비스(서비스명 :<a href="http://www.gzonei.com"> http://www.gzonei.com</a>)이하 &#34;서비스&#34;라 함)의 이용조건 및 절차에 관한 사항과 기타 이용에 필요한 사항을 규정함을 목적으로 한다.</p>
					    ...
					    <div class="agree-box">
		                    ...
		                    <p>전국개발정보 지존(이하&#34;회사&#34;라 함)은 개인정보를 다음의 목적이외의 용도로는 이용하지 않으며 이용 목적이 변경될 경우에는 동의를 받아 처리하겠습니다.</p>
		                    <ul>
		                        <li>1. 서비스 제공
		                    ...
		                    <ul>
		                        ...
		                        <li>5. 개인정보의 열람, 정정·삭제, 처리정지 요구 접수·처리 부서와 담당자는 아래와 같습니다.
		                            <ul>
		                                <li>부서 : 전국개발정보 지존 전산팀</li>
		                                <li>담당자 : 이호간 TEL. 02-322-3152, FAX. 02-322-3154</li>
		                                <li>주소 : 서울특별시 영등포구 당산로 246 VIEWTIFUL 8층</li>
		                            </ul>
		                        </li>
		                    </ul>
		                    <h2 class="h2">&#91; 파기 &#93;</h2>
