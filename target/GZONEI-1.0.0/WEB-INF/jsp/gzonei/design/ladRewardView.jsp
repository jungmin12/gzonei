            ...
            <!-- content 영역입니다. -->
                ...
                <div class="sub0704_wrap">
                    ...
                    <div class="inner layout">
                        <strong class="tit">본 서비스의 이용요금은 무료이며 <span>(주)전국개발정보 지존이 부설한 <em>지존토지보상지원센터</em>에서 </span>해당 업무를 수행합니다.</strong>
                        <div class="intro">
                            <div class="top">
                    ...
                    <ul class="guide_list">
                            ...
                            <li>
                                ...
                                <div class="txt">
                                    <p>(주)전국개발정보 지존(지존토지보상지원센터)은 토지보상금 정보 <span>이외에는 어떠한 경우에도 신청인의 개인정보를 수집, 보관 및 </span>활용하지 않습니다.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="txt">
                                    ...
                                    <a href="<c:url value='/css/gzonei/SRC/images/contents/sub07/downfile.hwp'/>" class="btn btn-primary">신청서 다운로드</a>
                                </div>
                            </li>
                            <li>
                                <span class="ir ico6"></span>
                                <div class="txt">
                                    <p>기타문의 사항은 지존 02-322-3152(대표) 또는 <span>지존토지보상지원센터 02-534-8393번으로 문의하시길 바랍니다.</span></p>
                                </div>
                            </li>
                        </ul>
                    </div>
