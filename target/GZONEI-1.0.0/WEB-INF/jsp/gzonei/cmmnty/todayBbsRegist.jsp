...
<script>
	...
	function cancle() {
		document.location.href="<c:url value='/cmmnty/todayBbsList.do'/>";
	}
	function insert() {
		if(validate()){	
		Common.Dialog.confirm({
            ...
            ,ok: function(){
            	document.insertForm.action="<c:url value='/cmmnty/todayBbsRgst.do'/>";
...
<!-- 										    	<option value="CM00200011">프리미엄 (스페셜)</option>  -->
									...
									<input type="hidden" name="bbsId"  value="BBSMSTR_000000000023"/>
