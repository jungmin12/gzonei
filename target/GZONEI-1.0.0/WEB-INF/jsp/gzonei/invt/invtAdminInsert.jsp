				...
				<div class="modal_form">
					<div class="form-horizontal bucket-form">
						...
						<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" id="dwkno" name="dwkno" readonly
								...
								<div class="col-sm-4">
									<input type="text" id="dwknm" name="dwknm" readonly
										class="form-control disabled" value="">
								</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="incrprAt" id="incrprAt" class="form-control">
							...
							<div class="col-sm-4">
								<input type="text" id="incrprAr" name="incrprAr"
									class="form-control" value="" placeholder="Ex)100000">
							</div>
						</div>
						<div id="aucAdmDiv1">
							<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="addr" name="addr" title="상세 주소 입력"
									class="form-control" placeholder="Ex)당산동6가 236 외 2필지">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-2 control-label col-lg-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="apasmtAmount" name="apasmtAmount"
									title="사건번호 입력" class="form-control" placeholder="Ex)25000000">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-2 control-label col-lg-2">
